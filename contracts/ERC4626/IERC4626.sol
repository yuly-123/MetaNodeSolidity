...
interface IERC4626 is IERC20, IERC20Metadata
{
    ...
    /**
     * @dev 提款函数: owner 地址销毁 shares 单位的金库额度，然后合约将 assets 单位的基础资产发送给 receiver 地址（销毁 shares 金库额度，获得 assets 基础资产）
     * - 释放 Withdraw 事件
     * - 如果全部基础资产不能提取，将revert
     */
    function withdraw(uint256 assets, address receiver, address owner) external returns (uint256 shares);
    /**
     * @dev 赎回函数: owner 地址销毁 shares 数量的金库额度，然后合约将 assets 单位的基础资产发送给 receiver 地址（销毁 shares 金库额度，获得 assets 基础资产）
     * - 释放 Withdraw 事件
